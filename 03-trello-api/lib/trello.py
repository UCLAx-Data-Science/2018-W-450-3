...
class Trello(object):
    ...
    def __init__(self):
        ...
        self.api_key = credentials['TRELLO_API_KEY']
        self.oauth_token = credentials['TRELLO_OAUTH_TOKEN']
        self.board_id = credentials['BOARD_ID']
        self.base_url = 'https://api.trello.com/1'

    def getLists(self, closed=False):
        if closed:
            return self.makeRequest('GET', '/boards/' + self.board_id + '/lists/closed')
    ...
    def getCards(self, list_id, closed=False):
        if closed:
            return self.makeRequest('GET', '/lists/' + list_id + '/cards/closed')
